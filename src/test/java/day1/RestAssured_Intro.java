...
public class RestAssured_Intro {
    ...
    public void testHelloEndPoint(){
        // get http://100.26.232.232:8000/api/hello
        // Save the response into a object with type response
        Response response = get("http://100.26.232.232:8000/api/hello");
    ...
    public void testingSingleSpartan(){
        // Send request to Get http://100.26.232.232:8000/api/spartans/3
        // Save the response and print out whole response
        Response response = get("http://100.26.232.232:8000/api/spartans/16").prettyPeek();
        ...
        // assert these values according to what you print using hamcrest matchers
