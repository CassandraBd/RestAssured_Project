...
public class SpartanWithAuthTest extends SpartanWithAuthBaseTest{
    ...
    @DisplayName("GET /spartans as public user except 401")
    @Test
    ...
    @DisplayName("GET /spartans as admin user except 200")
    @Test
    ...
    @DisplayName("DELETE /spartans/{id} as editor user except 403")
    @Test
