...
public class HR_ORDS_API_DeserializationTest extends HR_ORDS_API_BaseTest {
    ...
    // We want to save the json data as pojo and we want to ignore any other fields other
    ...
    public void testAllEmployees() {
        ...
        // Till this moment we have been creating out pojo class field names to match exact
        // name from json field and yet there will be situations that the json field name does
        // not really work for java naming convention we want to be able to name the POJO field
        // anything we want
