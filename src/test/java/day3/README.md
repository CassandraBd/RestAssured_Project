...
Complete these tests according to the examples given
...
Third json object fields : Title , Ye# Note Day 3
Extracting response data using JsonPath
To make it clear what we refer when we talk about the word json path , let's see few places this word comes up : Few meaning of JsonPath :
...
Third json object fields : Title , Year, imdbID save and print all the json array imdbID in to List<String>
...
Eventually save all movie titles from all the pages into List